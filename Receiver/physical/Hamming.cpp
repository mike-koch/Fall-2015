...
void reverse_hamming(char *message, int length, char *returned_data) {
    ...
    for (int i = 0; i < length; i += 12, returned_data_index++) {
        /*
        ...
        char next_byte[8];
        next_byte[0] = message[i + 2];
        next_byte[1] = message[i + 4];
        next_byte[2] = message[i + 5];
        next_byte[3] = message[i + 6];
        next_byte[4] = message[i + 8];
        next_byte[5] = message[i + 9];
        next_byte[6] = message[i + 10];
        next_byte[7] = message[i + 11];
...
int check_hamming(char *message, int starting_index) {
    ...
    int syndrome = 0;
    int value = 1;
    value ^= message[starting_index];
    value ^= message[starting_index + 2];
    value ^= message[starting_index + 4];
    value ^= message[starting_index + 6];
    value ^= message[starting_index + 8];
    value ^= message[starting_index + 10];
    if (value != 0) {
        syndrome += 1;
    }
    ...
    value = 1;
    value ^= message[starting_index + 1];
    value ^= message[starting_index + 2];
    value ^= message[starting_index + 5];
    value ^= message[starting_index + 6];
    value ^= message[starting_index + 9];
    value ^= message[starting_index + 10];
    if (value != 0) {
        syndrome += 2;
    }
    ...
    value = 1;
    value ^= message[starting_index + 3];
    value ^= message[starting_index + 4];
    value ^= message[starting_index + 5];
    value ^= message[starting_index + 6];
    value ^= message[starting_index + 11];
    if (value != 0) {
        syndrome += 4;
    }
    ...
    value = 1;
    value ^= message[starting_index + 7];
    value ^= message[starting_index + 8];
    value ^= message[starting_index + 9];
    value ^= message[starting_index + 10];
    value ^= message[starting_index + 11];
    value ^= message[starting_index + 12];
    if (value != 0) {
        syndrome += 8;
    }
